  ...
  return (
    <div className="wrapper--algo-params">
      ...
      <form className="form--algo-params" noValidate autoComplete="off">
        ...
        <FormControl fullWidth={true}>
          <InputLabel id="train-test-split-type">Train Test Random Split Type</InputLabel>
        ...
        <FormControl fullWidth={true}>
          <FormLabel>Training Data Percentage</FormLabel>
          <Input type="number" inputProps={{ step: "0.1" }} />
        </FormControl>
        <FormControl fullWidth={true}>
          <FormLabel>Test Data Percentage</FormLabel>
          <Input type="number" inputProps={{ step: "0.1" }} />
        </FormControl>
        <FormControl fullWidth={true}>
          <FormLabel>Maximum Depth of Tree</FormLabel>
          <Input type="number" />
        </FormControl>
        <FormControl fullWidth={true}>
          <FormLabel>Maximum Number of Bins</FormLabel>
          <Input type="number" />
        </FormControl>
      </form>
    </div>
